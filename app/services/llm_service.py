...
Always cite your sources by mentioning the section title and page numbers."""
...
1. When images are provided, examine them carefully and reference them in your answer
2. Describe what you see in the images when relevant to the question
3. Cite sources by section title and page numbers
4. If an image directly answers the question, say so explicitly
5. Combine information from both text and images for comprehensive answers"""
